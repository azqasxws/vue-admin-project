...
![alt](https://github.com/azqasxws/vue-admin-project/blob/uploadFile/src/assets/img/1.png)


选择第二项并继续，并选择自己需要配置的功能，完成后并继续，然后开始生成项目

![alt](https://github.com/azqasxws/vue-admin-project/blob/uploadFile/src/assets/img/2.png)

项目初始化成功

![alt](https://github.com/azqasxws/vue-admin-project/blob/uploadFile/src/assets/img/3.png)
接下来按照上面的提示运行`cd app`以及启动本地服务器`npm run serve`,当运行完成之后会提示你打来本地端口`http://localhost:8080`,会出现欢迎页面，此时代表你的vue项目初始化完成。

![alt](https://github.com/azqasxws/vue-admin-project/blob/uploadFile/src/assets/img/5.png)
...
![首页](https://github.com/azqasxws/vue-admin-project/blob/uploadFile/src/assets/img/4.png)
1. 侧边栏
2. 顶部栏
3. 内容部分</br>
